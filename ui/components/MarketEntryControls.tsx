...
export function MarketEntryControls({
  ...
  const balanceError = (() => {
    ...
    if (marketMode === 'enter') {
      ...
      maxBalance = selectedToken === 'sol' ? (solBalance || 0) : (oogwayBalance || 0);
    } else {
    ...
    if (inputAmount > maxBalance) {
      ...
      return `Insufficient balance. Max: ${maxBalance.toFixed(decimals)} ${selectedToken === 'sol' ? 'SOL' : '$oogway'}`;
    }
    ...
    <div className={`p-3 rounded-lg ${
      ...
      <div className="relative mb-3">
        ...
        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
          ...
          <button
            onClick={() => onTokenChange(selectedToken === 'sol' ? 'oogway' : 'sol')}
