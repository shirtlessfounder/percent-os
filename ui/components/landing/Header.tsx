...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 w-screen h-[60px] bg-black z-50 flex items-center justify-center" style={{ borderBottom: '1px solid #494949' }}>
      <div className="w-full max-w-[1512px] flex items-center justify-between px-3 sm:px-6">
